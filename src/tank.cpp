...
Tank::Tank(TankId tankId, const TankConfig &tankConfig, b2WorldId worldId)
  ...
  gunShapeDef.filter.maskBits =
      CategoryBits::ALL &
      ~(CategoryBits::TANK_GUN | CategoryBits::TANK_BODY |
        CategoryBits::PROJECTILE | CategoryBits::WALL | CategoryBits::OBSTACLE);
...
float Tank::getAngularVelocity() {
  /* Get the angular velocity of the tank */

  // Return angular velocity
  return b2Body_GetAngularVelocity(mTankBodyId);
}
