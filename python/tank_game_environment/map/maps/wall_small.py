...
class WallSmall(MapData):
    ...
    obstacle_map_data: list[ObstacleMapData] = field(
        default_factory=lambda: [
            ObstacleMapData(position_x=50, position_y=100, radius=5),
            ObstacleMapData(position_x=50, position_y=75, radius=5),
            ObstacleMapData(position_x=50, position_y=50, radius=5),
            ObstacleMapData(position_x=50, position_y=25, radius=5),
            ObstacleMapData(position_x=50, position_y=0, radius=5),
        ]
    )
